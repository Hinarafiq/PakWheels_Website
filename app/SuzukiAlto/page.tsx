...
export default function SuzukiAlto () {
    return (
      <div className=" bg-blue-100 w-full h-full">
         <h1 className="flex justify-center items-center font-bold pt-5">Suzuki Alto 2024 Price in Pakistan, Images, Reviews & Specs</h1>
         <hr className="text-black" />

        <div className="flex justify-center items-center">
            <Image src="https://cache4.pakwheels.com/system/car_generation_pictures/6013/original/Suzuki_Alto_-_PNG.png?1635945100" 
            alt="Image Of Suzuki Alto" width="200" height="96" className=" mt-3"/>
        </div>
        ...
        <div className="flex justify-center items-center">
         ...
         <h1 className="flex justify-center items-center font-medium text-green-500">PKR 3,045,000 </h1>
        <div className="flex justify-center items-center">
